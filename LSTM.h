...
public:
  ...
  inline void updateAdam(dtype belta1, dtype belta2, dtype regularizationWeight, dtype adaAlpha, dtype adaEps) {
    _lstm_output.updateAdam(belta1, belta2, regularizationWeight, adaAlpha, adaEps);
    _lstm_input.updateAdam(belta1, belta2, regularizationWeight, adaAlpha, adaEps);
    _lstm_forget.updateAdam(belta1, belta2,regularizationWeight, adaAlpha, adaEps);
    _lstm_cell.updateAdam(belta1, belta2, regularizationWeight, adaAlpha, adaEps);
